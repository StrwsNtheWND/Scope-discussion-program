...
function wireStaticButtons() {
  ...
  document.getElementById("btn-example-baker").addEventListener("click", () => {
    createChecklist(buildBakerExampleChecklist());
  });

  document.getElementById("btn-example-insulation").addEventListener("click", () => {
    createChecklist(buildInsulationExampleChecklist());
  });

  document.getElementById("btn-example-fireprotection").addEventListener("click", () => {
    createChecklist(buildFireProtectionExampleChecklist());
  });

  document.getElementById("btn-example-sce").addEventListener("click", () => {
    createChecklist(buildSceExampleChecklist());
  });

  document.getElementById("btn-example-pjd").addEventListener("click", () => {
  ...
  document.getElementById("btn-example-bfs").addEventListener("click", () => {
    createChecklist(buildBfsExampleChecklist());
  });
...
function init() {
  ...
  if (state.checklists.length === 0) {
    ...
    const bakerExample = buildBakerExampleChecklist();
    const insulationExample = buildInsulationExampleChecklist();
    ...
    state.checklists.push(concreteExample, esiExample, ctfExample, bakerExample, insulationExample, fireProtectionExample, sceExample, pjdExample, kgExample, bfsExample);
